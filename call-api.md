    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p></p>
                <blockquote>Если в параметре <code>contact_message type</code> имеет значение <code>tts</code>, то параметр <code>switch_at_once=true</code> не работает</blockquote>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote>Проигрывается всегда тому плечу, для которого не задан один из параметров <code>contact_message</code> или <code>employee_message</code></blockquote>
                <p></p>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <blockquote> В качестве виртуального номера запрещено использовать 800-е номера</blockquote>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote>Внутренние номера сотрудников не поддерживаются.</blockquote>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote>Если не указан параметр <code>phone_number</code>, то будет совершен последовательный обзвон всех активных номеров сотрудника.</blockquote>
            </td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote> После окончания проигрывания сообщения, будет проигрываться покругу сообщение из параметра <code>media_file_id</code></blockquote>
            </td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote> Длина TTS сообщения регулируется тарифным планом и установленным лимитом.</blockquote>
            </td>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote>Если не задан параметр <code>contact_message</code>, то абоненту будет проигрываться системная мелодия - <code>Музыка переадресации (dialing_music)</code></blockquote>
                <blockquote>Внутренние номера сотрудников не поддерживаются.</blockquote>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <p>Определяет параметры сообщения, которое необходимо проиграть абоненту заданному в параметре <code>contact</code>.</p>
                <blockquote> После окончания проигрывания сообщения, будет проигрываться покругу системная мелодия - <code>Музыка переадресации (dialing_music)</code></blockquote>
            </td>
        </tr>
        <tr>
            <td></td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote>Проигрывается всегда тому плечу, для которого не задан один из параметров <code>contact_message</code> или <code>operator_message</code></blockquote>
                <p></p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote>Не является сотрудником и в отчетах не будет фигурировать как сотрудник</blockquote>
            </td>
        </tr>
        <tr>
            <td colspan="2">contact_message</td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote> Может быть внутренний номер, внешний номер, номер сотрудника, sip-номер</blockquote>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote> Абонент, который стоит на удержании, будет ожидать ответа, пока не будет прослушано сообщение до конца</blockquote>
            </td>
        </tr>
        <tr>
            <td></td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <blockquote> В некоторых случаях может отсутствовать. К примеру, обязательный параметр вообще не был заполнен.</blockquote>
            </td>
        </tr>
        <tr>
            <td></td>
